...
CREATE TABLE CID_CIDADE(
  ...
  CID_NOME varchar(120) NOT NULL,
  EST_CODIGO INT NOT NULL,
  FOREIGN KEY (EST_CODIGO) REFERENCES EST_ESTADO (EST_CODIGO));

INSERT INTO CID_CIDADE (CID_CODIGO, CID_NOME, EST_CODIGO) VALUES
(1, 'Afonso Cláudio', 8),
...
INSERT INTO `d2vs`.`usu_usuario` (`USU_NOME`, `USU_EMAIL`, `USU_SENHA`, `USU_SEXO`, `USU_CPF`, `USU_RG`, `USU_DT_NASCIMENTO`, `USU_CELULAR`, `USU_TELEFONE`, `USU_BAIRRO`, `USU_ENDERECO`, `USU_CEP`, `USU_COMPLEMENTO`, `USU_ATIVO`, `USU_PAGA_PREMIUM`, `CID_CODIGO`, `TUS_CODIGO`) 
VALUES ('autonomo', 'aut@aut.com', 'PJkJr+wlNU1VHa4hWQuybjjVPyFzuNPcPu5MBH56scHri4UQPjvnumE7MbtcnDYhTcnxSkL9ei/bhIVrylxEwg==', 'm', '1', '1', '1990-01-01', '1', '1', '1', '1', '1', '1', 's', 'n', '1', '1');
