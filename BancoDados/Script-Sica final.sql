...
CREATE TABLE IF NOT EXISTS D2VS.CES_CIDADE_ESTADO (
	...
	CONSTRAINT fk_CIDADE_ESTADO_ESTADO1		FOREIGN KEY (EST_CODIGO)		REFERENCES D2VS.EST_ESTADO (EST_CODIGO),
	CONSTRAINT fk_CIDADE_ESTADO_CIDADE1		FOREIGN KEY (CID_CODIGO)		REFERENCES D2VS.CID_CIDADE (CID_CODIGO)
);
CREATE TABLE IF NOT EXISTS D2VS.TMI_TIPO_MIDIA (
	TMI_CODIGO INT PRIMARY KEY AUTO_INCREMENT,
	TMI_DESCRICAO VARCHAR(100) NOT NULL
);

CREATE TABLE IF NOT EXISTS D2VS.TUS_TIPO_USUARIO (
...
CREATE TABLE IF NOT EXISTS D2VS.USU_USUARIO (
	...
	CONSTRAINT fk_usuario_tipo_usuario1		FOREIGN KEY (TUS_CODIGO)				REFERENCES D2VS.TUS_TIPO_USUARIO (TUS_CODIGO),
	CONSTRAINT fk_USUARIO_CIDADE_ESTADO1	FOREIGN KEY (EST_CODIGO , CID_CODIGO)	REFERENCES D2VS.CES_CIDADE_ESTADO (EST_CODIGO , CID_CODIGO)
);
CREATE TABLE IF NOT EXISTS D2VS.MUL_MULTIMIDIA (
	...
	CONSTRAINT fk_multimidia_autonomo1		FOREIGN KEY (USU_CODIGO)		REFERENCES D2VS.USU_USUARIO (USU_CODIGO),
	CONSTRAINT fk_MULTIMIDIA_TIPO_MIDIA1		FOREIGN KEY (TMI_CODIGO)		REFERENCES D2VS.TMI_TIPO_MIDIA (TMI_CODIGO)
);	
CREATE TABLE IF NOT EXISTS D2VS.FVR_FAVORITO (
	...
	CONSTRAINT fk_favoritos_usuario1		FOREIGN KEY (USU_CODIGO_CLIENTE)		REFERENCES D2VS.USU_USUARIO (USU_CODIGO),
	CONSTRAINT fk_favoritos_usuario2		FOREIGN KEY (USU_CODIGO_AUTONOMO)		REFERENCES D2VS.USU_USUARIO (USU_CODIGO)
);
CREATE TABLE IF NOT EXISTS D2VS.AVS_AVALIACAO_SERVICO (
	...
	CONSTRAINT fk_Avaliacao_de_Servico_usuario1		FOREIGN KEY (USU_CODIGO_CLIENTE)		REFERENCES D2VS.USU_USUARIO (USU_CODIGO),
	CONSTRAINT fk_Avaliacao_de_Servico_usuario2		FOREIGN KEY (USU_CODIGO_AUTONOMO)		REFERENCES D2VS.USU_USUARIO (USU_CODIGO)
);
CREATE TABLE IF NOT EXISTS D2VS.OCR_OCORRENCIA (
	...
	CONSTRAINT fk_Ocorrencia_usuario1	FOREIGN KEY (USU_CODIGO_CLIENTE)	REFERENCES D2VS.USU_USUARIO (USU_CODIGO),
	CONSTRAINT fk_Ocorrencia_usuario2 	FOREIGN KEY (USU_CODIGO_AUTONOMO)	REFERENCES D2VS.USU_USUARIO (USU_CODIGO)
);
CREATE TABLE IF NOT EXISTS D2VS.MOT_MOTIVO (
	...
	CONSTRAINT fk_Motivo_usuario1	FOREIGN KEY (USU_CODIGO)	REFERENCES D2VS.USU_USUARIO (USU_CODIGO),
	CONSTRAINT fk_Motivo_usuario2	FOREIGN KEY (USU_CODIGO_ADMIN_DESATIV)	REFERENCES D2VS.USU_USUARIO (USU_CODIGO),
	CONSTRAINT fk_Motivo_usuario3	FOREIGN KEY (USU_CODIGO_ADMIN_ATIV)	REFERENCES D2VS.USU_USUARIO (USU_CODIGO)
);
CREATE TABLE IF NOT EXISTS D2VS.ESP_ESPECIALIDADE (
	ESP_CODIGO INT PRIMARY KEY AUTO_INCREMENT,
	ESP_NOME VARCHAR(50) NOT NULL
);
CREATE TABLE IF NOT EXISTS D2VS.ATU_ATUACAO (
	ATU_CODIGO INT PRIMARY KEY,
	ATU_AREA VARCHAR(70) NOT NULL
);
CREATE TABLE IF NOT EXISTS D2VS.PRO_PROFISSAO (
	...
	CONSTRAINT fk_profissao_atuacao1	FOREIGN KEY (ATU_CODIGO)	REFERENCES D2VS.ATU_ATUACAO (ATU_CODIGO)
);
CREATE TABLE IF NOT EXISTS D2VS.PES_PROFISSAO_ESPECIALIDADE (
	...
	CONSTRAINT fk_profissao_has_especialidade_profissao1	FOREIGN KEY (PRO_CODIGO)	REFERENCES D2VS.PRO_PROFISSAO (PRO_CODIGO),
	CONSTRAINT fk_profissao_has_especialidade_especialidade1	FOREIGN KEY (ESP_CODIGO)	REFERENCES D2VS.ESP_ESPECIALIDADE (ESP_CODIGO)
);
CREATE TABLE IF NOT EXISTS D2VS.PEA_PROFISSAO_ESPECIALIDADE_AUTONOMO (
	PRO_CODIGO INT NOT NULL,
	ESP_CODIGO INT NOT NULL,
	USU_CODIGO INT NOT NULL,
	...
	INDEX fk_profissao_has_especialidade_has_autonomo_profissao_has_e_idx (PRO_CODIGO ASC, ESP_CODIGO ASC),
	CONSTRAINT fk_profissao_has_especialidade_has_autonomo_profissao_has_esp1	FOREIGN KEY (PRO_CODIGO , ESP_CODIGO)	REFERENCES D2VS.PES_PROFISSAO_ESPECIALIDADE (PRO_CODIGO , ESP_CODIGO),
	CONSTRAINT fk_profissao_has_especialidade_has_autonomo_autonomo1	FOREIGN KEY (USU_CODIGO)	REFERENCES D2VS.USU_USUARIO (USU_CODIGO)
);
CREATE TABLE IF NOT EXISTS D2VS.AGE_AGENDAMENTO (
	...
	CONSTRAINT fk_AGENDAMENTO_PROFISSAO_ESPECIALIDADE_AUTONOMO1	FOREIGN KEY (PEA_CODIGO , PEA_ESPECIALIDADE , PEA_AUTONOMO)	REFERENCES D2VS.PEA_PROFISSAO_ESPECIALIDADE_AUTONOMO (PES_CODIGO , PES_CODIGO , USU_CODIGO),
	CONSTRAINT fk_AGENDAMENTO_USUARIO1	FOREIGN KEY (USU_CODIGO_CLIENTE)	REFERENCES D2VS.USU_USUARIO (USU_CODIGO)
);
CREATE TABLE IF NOT EXISTS D2VS.LEI_LEILAO (
	...
	CONSTRAINT fk_LEI_LEILAO_USU_USUARIO2		FOREIGN KEY (USU_CODIGO)	REFERENCES D2VS.USU_USUARIO (USU_CODIGO),
	CONSTRAINT fk_LEI_LEILAO_ESP_ESPECIALIDADE1	FOREIGN KEY (ESP_CODIGO)	REFERENCES D2VS.ESP_ESPECIALIDADE (ESP_CODIGO)
);
CREATE TABLE IF NOT EXISTS D2VS.AUL_AUTONOMO_LEILAO (
	...
	CONSTRAINT fk_AUL_AUTONOMO_LEILAO_USU_USUARIO1	FOREIGN KEY (USU_CODIGO_AUTONOMO)	REFERENCES D2VS.USU_USUARIO (USU_CODIGO),
	CONSTRAINT fk_AUL_AUTONOMO_LEILAO_LEI_LEILAO1	FOREIGN KEY (LEI_CODIGO)	REFERENCES D2VS.LEI_LEILAO (LEI_CODIGO)
);
