...
CREATE TABLE IF NOT EXISTS D2SV.CIDADE_ESTADO (
  ...
  INDEX fk_CIDADE_ESTADO_CIDADE1_idx (ID_CIDADE ASC),
  CONSTRAINT fk_CIDADE_ESTADO_ESTADO1
    FOREIGN KEY (ID_ESTADO)
    REFERENCES D2SV.ESTADO (ID_ESTADO)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT fk_CIDADE_ESTADO_CIDADE1
    FOREIGN KEY (ID_CIDADE)
    REFERENCES D2SV.CIDADE (ID_CIDADE)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION
);
...
CREATE TABLE IF NOT EXISTS D2SV.PROFISSAO (
	...
	REFERENCES D2SV.ATUACAO (ID_ATUACAO)
	ON DELETE NO ACTION
	ON UPDATE NO ACTION);
...
CREATE TABLE IF NOT EXISTS D2SV.PROFISSAO_ESPECIALIDADE (
	...
	REFERENCES D2SV.PROFISSAO (ID)
	ON DELETE NO ACTION
	ON UPDATE NO ACTION,
	CONSTRAINT fk_especialidade
	FOREIGN KEY (ID_ESPECIALIDADE)
	REFERENCES D2SV.ESPECIALIDADE (ID_ESPECIALIDADE)
	ON DELETE NO ACTION
	ON UPDATE NO ACTION);
...
CREATE TABLE IF NOT EXISTS D2SV.PROFISSAO_ESPECIALIDADE_AUTONOMO (
  ...
  CONSTRAINT fk_profissao_especialidade
    ...
    REFERENCES D2SV.PROFISSAO_ESPECIALIDADE (ID_PROFISSAO , ID_ESPECIALIDADE)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
...
CREATE TABLE IF NOT EXISTS D2SV.MULTIMIDIA (
  ...
  INDEX fk_multimidia_autonomo1_idx (ID_USUARIO ASC),
  INDEX fk_MULTIMIDIA_TIPO_MIDIA1_idx (ID_TIPO_MIDIA ASC),
  CONSTRAINT fk_multimidia_autonomo1
    FOREIGN KEY (ID_USUARIO)
    REFERENCES D2SV.USUARIO (ID)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT fk_MULTIMIDIA_TIPO_MIDIA1
    FOREIGN KEY (ID_TIPO_MIDIA)
    REFERENCES D2SV.TIPO_MIDIA (ID_TIPO_MIDIA)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION
);
...
CREATE TABLE IF NOT EXISTS D2SV.AGENDAMENTO (
  ...
  CONSTRAINT fk_agenda_profissao_especialidade_auto
    ...
    REFERENCES D2SV.PROFISSAO_ESPECIALIDADE_AUTONOMO (ID_PROFISSAO , ID_ESPECIALIDADE , ID_AUTONOMO)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
