...
CREATE TABLE IF NOT EXISTS D2SV.AGENDAMENTO (
  ...
  CONSTRAINT fk_AGENDAMENTO_PROFISSAO_ESPECIALIDADE_AUTONOMO1
...
CREATE TABLE IF NOT EXISTS D2SV.AVALIACAO_SERVICO (
  ...
  CONSTRAINT fk_avaliacao_servico_usuario    FOREIGN KEY (ID_USUARIO)    REFERENCES D2SV.USUARIO (ID),
  CONSTRAINT fk_avaliacao_servico_autonomo    FOREIGN KEY (ID_AUTONOMO)    REFERENCES D2SV.USUARIO (ID)
);